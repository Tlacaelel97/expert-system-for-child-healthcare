      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a href="#features" className="text-slate-400 hover:text-white transition-colors text-sm">Cómo funciona</a>
            <a href="#diseases" className="text-slate-400 hover:text-white transition-colors text-sm">Enfermedades</a>
